...
def parse_las(
    ...
    """Parse LAS survey content into a validated Survey object.

    Auto-maps MD, INC, AZI columns using the mnemonic dictionaries from
    drilling.io._column_mapping (LAS conventions: DEPT/DEPTH for MD,
    HAZI/AZIM for azimuth, DEVI/INCL for inclination).
    ...
    ----------
    content : bytes
        Raw bytes of the LAS file. Decoded as UTF-8 with replacement.
